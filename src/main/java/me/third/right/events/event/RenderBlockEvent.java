...
public class RenderBlockEvent extends ThirdEvents {
    ...
    public RenderBlockEvent(IBlockAccess blockAccess, IBakedModel bakedModel, IBlockState blockState, BlockPos blockPos, BufferBuilder bufferBuilder, boolean checkSides, long rand) {
