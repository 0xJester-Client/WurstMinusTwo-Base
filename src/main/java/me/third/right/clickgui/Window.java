...
public final class Window
{
	...
	public void pack()
	{
		...
		int titleBarWidth = (ThirdMod.hax.clickGuiHack.customFont.isChecked() ? Wrapper.getCFontRenderer().getStringWidth(title) + 4 : Wrapper.getFontRenderer().getStringWidth(title) + 4);
		if(minimizable)
			titleBarWidth += 11;
		if(pinnable)
			titleBarWidth += 11;
