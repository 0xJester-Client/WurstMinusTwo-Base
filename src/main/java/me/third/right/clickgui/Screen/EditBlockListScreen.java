...
public final class EditBlockListScreen extends GuiScreen
{
	...
	public void initGui()
	{
		...
		blockNameField = new GuiTextField(1, Wrapper.getFontRenderer(), 64, height - 55, 150, 18);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		drawCenteredString(Wrapper.getFontRenderer(), blockList.getName() + " (" + listGui.getSize() + ")", width / 2, 12, 0xffffff);
		...
		if(blockNameField.getText().isEmpty() && !blockNameField.isFocused())
			drawString(Wrapper.getFontRenderer(), "block name or ID", 68, height - 50, 0x808080);
