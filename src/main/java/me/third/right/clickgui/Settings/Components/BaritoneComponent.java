...
public final class BaritoneComponent extends Component {
    private final BaritoneSetting setting;

    public BaritoneComponent(BaritoneSetting setting)
    {
        ...
        switch (setting.getType()) {
            case Boolean:
                if (mouseButton == 0 || mouseButton == 1) {
                    setting.toggle(!setting.toggleState());
